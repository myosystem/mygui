# ==============================================================
# mygui — GUI 프로세스 (user-space .efi)
# ==============================================================
# Usage:
#   make              → Debug 빌드  → bin/x64/Debug/mygui.efi
#                                   → ../_bootpartition/.../mygui.o
#   make CONFIG=Release
#   make clean
# ==============================================================
...
TARGET   := $(OUTDIR)/mygui.efi
BOOT_OUT := ../_bootpartition/$(PLATFORM)/$(CONFIG)/mygui.o
...
all: $(TARGET)
	...
	$(OBJCOPY) -O binary \
	  ...
	  $(TARGET) $(BOOT_OUT)
	@echo "[mygui] done → $(TARGET)"
	@echo "[mygui] objcopy → $(BOOT_OUT)"
